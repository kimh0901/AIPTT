...
平台預設先讀取這個資料夾，再依序嘗試網路來源。母片解析與 PowerPoint 匯出所需的 `jszip.min.js`、`pptxgen.bundle.js` 已隨網站附上；其他功能一般可從網路載入。
...
| 檔案 | 對應功能 | 下載網址 |
|---|---|---|
| `jszip.min.js` | 解析與套用 PowerPoint 母片（已附） | https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js |
| `pptxgen.bundle.js` | 匯出 PowerPoint（已附） | https://cdn.jsdelivr.net/npm/pptxgenjs@4.0.1/dist/pptxgen.bundle.js |
